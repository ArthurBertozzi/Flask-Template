...
from project_name import app, database, bcrypt
from flask_login import login_required, login_user, current_user, logout_user
from project_name.forms import FormLogin, FormRegister, FormFoto
from project_name.models import Usuario, Foto
import os
